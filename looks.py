...
# Categorias básicas para montar um look completo
...
async def generate_looks(
    ...
    """
    Gera looks de forma determinística + leve aleatoriedade.
    Em produção, substituir a lógica de seleção por chamada a LLM + embeddings.
    """
    ...
    for i in range(request.count):
        ...
        # Fallback se não conseguiu montar look mínimo
        if len(selected) < 2:
